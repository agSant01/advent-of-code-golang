...
func main() {
	...
	cmd := &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{Name: "day", Local: false, Aliases: []string{"d"}, Required: false, Value: time.Now().Format("02")},
			&cli.StringFlag{Name: "year", Local: false, Aliases: []string{"y"}, Required: false, Value: time.Now().Format("2006")},
		},
		EnableShellCompletion: true,
		HideHelp:              false,
		HideVersion:           false,
